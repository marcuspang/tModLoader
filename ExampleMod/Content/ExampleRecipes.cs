...
namespace ExampleMod.Content
{
	...
	public class ExampleRecipes : ModSystem
	{
		...
		public override void AddRecipeGroups() {
			...
			ExampleRecipeGroup.Register();
			RecipeGroup.recipeGroupIDs["ExampleMod:ExampleItem"] = ExampleRecipeGroup.RegisteredId;

			// Add an item to an existing Terraria recipeGroup. ExampleCritterItem isn't gold but it serves as an example for this.
			RecipeGroups.GoldenCritter.ValidItems.Add(ModContent.ItemType<ExampleCritterItem>());
			...
			SilverBarRecipeGroup.Register();
			RecipeGroup.recipeGroupIDs[nameof(ItemID.SilverBar)] = SilverBarRecipeGroup.RegisteredId;
		}
