...
public static class TileSnapshot
{
	...
	public struct TileStruct
	{
		...
		[FieldOffset(8)]
		private int _i2;
		private static string[] _liquidNames = new string[4] {
			"water",
			"lava",
			"honey",
			"shimmer"
			...
			public static TileStruct From(Tile tile)
			{
				...
				result._sTileHeader = 0;
				result._liquid = tile.liquid;
				result._bTileHeader = 0;
				result._wall_bTileHeader3_packed = wall;
		...
		public override int GetHashCode() => _i0 ^ _i1 ^ _i2;
