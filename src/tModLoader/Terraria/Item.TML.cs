...
#region Globals
	...
	/* Removed: IsNetStateDifferent now in vanilla 1.4.5 */
	...
	public List<PrefixCategory> GetPrefixCategories() {
		...
		if (PrefixLegacy.ItemSets.GunsBows[type] || ItemLoader.RangedPrefix(this))
			...
			if ((PrefixLegacy.ItemSets.Magic[type] || PrefixLegacy.ItemSets.Summon[type]) || ItemLoader.MagicPrefix(this))
	...
	public bool IsTheSameAs(Item compareItem) => !IsNotTheSameAs(compareItem);
	}
