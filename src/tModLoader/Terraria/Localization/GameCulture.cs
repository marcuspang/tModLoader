...
public class GameCulture
{
	...
	public static IEnumerable<GameCulture> KnownCultures => _legacyCultures?.Values ?? Enumerable.Empty<GameCulture>();
	...
	static GameCulture()
	{
		_NamedCultures = new Dictionary<CultureName, GameCulture> {
			...
			{ CultureName.Japanese, new GameCulture("ja-JP", 10) },
			{ CultureName.Korean, new GameCulture("ko-KR", 11) },
			{ CultureName.ChineseTraditional, new GameCulture("zh-Hant", 12) }
		};
