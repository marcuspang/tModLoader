...
public partial class DustID
{
	...
	{
		public static SetFactory Factory = new SetFactory(DustLoader.DustCount, "DustID.Sets");
	}
#endif
	...
	/* Removed: Glass and Corruption now in vanilla 1.4.5 */
	...
	/* Removed: Chlorophyte now in vanilla 1.4.5 (value 157) */
	...
	/* Removed: HeatRay now in vanilla 1.4.5 */
	...
	/* Removed: PlanteraBulb now in vanilla 1.4.5 */
