...
public static class MusicID
{
	...
	{
		public static SetFactory Factory = new SetFactory(105, "MusicID.Sets");
		public static bool[] CanBeRecorded = Factory.CreateBoolSet(true, 0, 28, 45, 103, 102);
		/// <summary>Tracks in this set bypass the volume remap and use direct volume control.</summary>
		public static bool[] SkipsVolumeRemap = Factory.CreateBoolSet(false);
	}

	public const int None = 0;
	public const int Title = TitleClassic;
