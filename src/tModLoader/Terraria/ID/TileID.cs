...
public partial class TileID
{
	...
	public static partial class Sets
	{
		...
		public static class TileCutIgnore
		{
			...
			/// <summary> Tiles that should be ignored by the <see cref="ItemID.StaffofRegrowth"/> hitbox despite being <see cref="Main.tileCut"/>. </summary>
		...
		{
			public static int[] CountsAsChairTypes = new int[6] {
				15,
				79,
				89,
				102,
		...
		/// <br/> Tree trunks are a type of tile anchor (<see cref="Enums.AnchorType.Tree"/>), targetable by axes, and are replanted when using the <see cref="ItemID.AcornAxe"/>.
		/// <br/> Defaults to <see langword="false"/>.
		/// </summary>
		...
		/// <summary> Indicates that this tile is a vine tile. Used to limit vine growth in an area and facilitates converting vines when the anchor tile is changed. </summary>
		...
		public static bool[] HasOutlines = Factory.CreateBoolSet(10, 11, 15, 21, 29, 55, 79, 85, 88, 89, 97, 102, 104, 125, 132, 136, 139, 144, 207, 209, 212, 215, 216, 237, 287, 335, 338, 354, 356, 377, 386, 387, 388, 389, 410, 411, 425, 441, 455, 463, 467, 468, 470, 475, 487, 480, 494, 497, 509, 510, 511, 621, 464, 657, 658, 663, 699, 720, 721, 725, 733, 16, 17, 18, 26, 77, 86, 94, 96, 101, 106, 114, 133, 134, 217, 218, 220, 228, 243, 247, 283, 300, 301, 302, 303, 304, 305, 306, 307, 308, 412, 499, 622, 355, 172);
			...
			public static bool[] CountsAsHoneyForCrafting = Factory.CreateBoolSet(false);
			public static bool[] CountsAsLavaForCrafting = Factory.CreateBoolSet(false);
			public static bool[] CountsAsShimmerForCrafting = Factory.CreateBoolSet(false);
